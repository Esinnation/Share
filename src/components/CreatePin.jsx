...
const CreatePin = ({user}) => {
  ...
  return (
    <div className='flex flex-col justify-center items-center mt-5 h-4/5'>
      {fields &&(
      ...
      <div className='flex lg:flex-row flex-col justify-center items-center lg:p-5 p-3 lg:w-4/5 w-full'>
        ...
        <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
              <input 
                ...
                className='outline-none text-2xl sm:text-3xl font-bold border-b-2 border-grey-200 p-2'
              />
              {user && (
              ...
              <div className='flex flex-col'>
                <div>
                  ...
                  <select
                    ...
                    className='outline-none w-4/5 text-base border-b-2 border-gray-200 p-2 rounder-md cursor-pointer'
                  >
                    <option value="other" className='bg-white'>Select Category</option>
                    {categories.map(category=>(
                      <option value={category.name} className='text-base border-o outline-none capitalize bg-white text-black'>
                        {category.name}
                      </option>
                    ))}
                  </select>
