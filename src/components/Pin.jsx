          ...
          <div className='flex items-center justify-between'>
            <div className='flex gap-2'>
              <a href={`${image?.asset?.url}?dl=`}
                ...
                className='cursor-pointer  bg-white w-9 h-9 rounded-full flex items-center justify-center text-dark text-xl opacity-75 hover:opacity-100 hover:shadow-md outline-none'
              >
                <MdDownloadForOffline/>
              </a>
            </div>
            {alreadySaved ? (
              <button type='button' className='bg-red-500 opacity-70 hover:opacity-100 font-bold text-white px-5 py-1 text-base rounded-3xl hover:shadow-md outline-none '>
                {save?.length} Saved
              </button>
            ):
              <button onClick={(e)=> {
              ...
              type='button' className='bg-red-500 opacity-70 hover:opacity-100 font-bold text-white px-5 py-1 text-base rounded-3xl hover:shadow-md outline-none '>
